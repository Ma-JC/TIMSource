TCGA_ui_explore_pm = function(){
  ...
  tagList(
    ...
    box(width = 12,
        ...
        reactableOutput(outputId = "TCGA_detial_pm")
    ),
    box(width = 12,
        tabsetPanel(
          id = "explore_TCGA_pm",
          tabPanel(title = "Immune-associated analysis",
                   ...
                   selectInput(inputId = "TCGA_cell_type_pm",label = h4("Immune cell type"),choices = c('Activated B cell',
                   ...
                   withSpinner(reactableOutput(outputId = "TCGA_immune_infiltrating_pm"),type = 1),
                   br(),
                   h3("Immune-related signatures",style="color:#033c73;font-weight: bold;"),
                   hr(style="background-color:#033c73;height:1px"),
                   selectInput(inputId = "TCGA_signature_pm",label = h4("Immune_related signatures"),choices = c('6-gene IFN signature',
                   ...
                   withSpinner(reactableOutput(outputId = "TCGA_immune_signature_pm"),type = 1)
          ),
